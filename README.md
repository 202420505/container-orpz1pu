...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-orpz1pu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-orpz1pu.containers.anotherwebservice.com/
...
```
git clone git@github.com:202420505/container-orpz1pu.git
cd container-orpz1pu
```
...
```
docker attach container-orpz1pu
```
